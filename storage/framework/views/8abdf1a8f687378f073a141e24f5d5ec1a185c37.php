            ...
            <h2>Editar perfil:</h2>
                            ...
                            <?php echo method_field('put'); ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cajaNombre" name="cajaNombre" value="<?php echo e(Auth::user()->name); ?>">
                                    <br>
                                    <label for="telefono">Digite telefono</label>
                                    <input type="text" class="form-control" id="cajaTelefono" name="cajaTelefono" value="<?php echo e(Auth::user()->telefono); ?>">
                                </div>
